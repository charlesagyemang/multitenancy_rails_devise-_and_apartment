...
class ComapniesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comapny" do
    assert_difference('Comapny.count') do
      post comapnies_url, params: { comapny: { name: @comapny.name, subdomain: @comapny.subdomain } }
    end
  ...
  test "should update comapny" do
    patch comapny_url(@comapny), params: { comapny: { name: @comapny.name, subdomain: @comapny.subdomain } }
