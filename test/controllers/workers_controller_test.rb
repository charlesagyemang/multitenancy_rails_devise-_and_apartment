...
class WorkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worker" do
    assert_difference('Worker.count') do
      post workers_url, params: { worker: { company_id: @worker.company_id, name: @worker.name, position: @worker.position } }
    end
  ...
  test "should update worker" do
    patch worker_url(@worker), params: { worker: { company_id: @worker.company_id, name: @worker.name, position: @worker.position } }
